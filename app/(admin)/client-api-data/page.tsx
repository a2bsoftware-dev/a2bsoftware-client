...
// Stands in for a list of QualificationCard blocks while qualifications are
// being fetched from Zamplia (used in both the campaign modal's Qualifications
// tab and the standalone qualifications viewer popup).
